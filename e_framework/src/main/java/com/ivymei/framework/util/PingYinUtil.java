...
public class PingYinUtil {
	...
	private static PingYinUtil characterParser = new PingYinUtil();
	 ...
	 * @return String
	 */
	public static String getFirstStrFirstChar(String str) {
		String convert = "";
		if(str != null && str.length() > 0){
			String result = getFirstSpell(str);
			convert += result.charAt(0);
		}
		return convert.toUpperCase();
	}
	...
	public static void main(String[] args) {
		PingYinUtil parser = PingYinUtil.getInstance();
		System.out.println(parser.getFirstStrFirstChar("wed"));
	}
}
...
import com.ivymei.framework.plugin.cache.Cache;
...
public abstract class RSAUtils {
	...
	/** 保存生成的密钥对的文件名称。 */
	private static final String RSA_PAIR_FILENAME = "RSA_PAIR_RSAUtils_"+ALGORITHOM+KEY_SIZE;
	...
	private static boolean isCreateKeyPairFile() {
		...
		Cache cache = DataCache.getCache();
		Object object = cache.getBySerialize(RSA_PAIR_FILENAME);
		return object == null;
	}
	...
	private static void saveKeyPair(KeyPair keyPair) {
		DataCache.getCache().put(RSA_PAIR_FILENAME, keyPair);
	}
	...
	public static String decryptString(PrivateKey privateKey, String encrypttext) {
		...
		try {
			...
			logger.debug("解密之后的字节长度"+data.length);
	...
	public static void main(String[] args) throws Exception {
		String source = "张小姐你好啊";// 要加密的字符串
		KeyPair keyPair = getKeyPair();
		String cryptograph = RSAUtils
				.encryptString(keyPair.getPublic(), source);// 生成的密文
		System.out.println(cryptograph);
		String target = RSAUtils.decryptString(keyPair.getPrivate(),
				cryptograph);// 解密密文
